...
# plink_path='plink'
# genotype_path='/fs0/zhoud2/tools/mrjti/data/jti_example_geno'
# tmp_folder='/fs0/zhoud2/tools/mrjti/data/tmp'
# expression_path='/fs0/zhoud2/tools/mrjti/data/jti_example_exp.txt'
# gencode_path='/fs0/zhoud2/tools/mrjti/data/gencode.v32.GRCh37.txt'
# out_path='/fs0/zhoud2/tools/mrjti/result'

# main_path=/scratch/zhoud2/tools/MR-JTI/
# Rscript ${main_path}/src/JTI.r \
# --tissue Adipose_Subcutaneous \
# --geneid ENSG00000182957 \
# --genotype_path ${main_path}/data/jti_example_geno \
# --tmp_folder ${main_path}/data/tmp \
# --expression_path ${main_path}/data/jti_example_exp.txt \
# --gencode_path ${main_path}/data/gencode.v32.GRCh37.txt \
# --out_path ${main_path}/result
...
#colnames(dosage_1m)[-1] <- gsub("\\.", "-", colnames(dosage_1m)[-1])
...
#---output---
  ...
  if (nrow(weight_file)>0){
    #save weight file
    write.table(weight_file,paste0(out_path,'/weight:',geneid,':',tissue,'.txt'),quote = F,row.names = F,sep = '\t')
    ...
    write.table(cov,paste0(out_path,'/cov:',geneid,':',tissue,'.txt'),quote = F,row.names = F,sep = '\t')
